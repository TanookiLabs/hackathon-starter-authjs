...
6. Remind the user: make sure their environment variables are set in Vercel Settings (AUTH_SECRET, DATABASE_URL). The DATABASE_URL in Vercel should point to the production Supabase project, not the dev one.
